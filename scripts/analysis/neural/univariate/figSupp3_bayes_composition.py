...
hemis = ['lh', 'rh', 'both']
analyses = ['composition','composition','composition']
rois = ['anteriortemporal-lh', 'anteriortemporal-rh','anteriortemporal-both']
rois_names = ['left anterior temporal lobe', 'right anterior temporal lobe','bilateral anterior temporal lobes']
...
# 9. FINALIZE & SAVE
out_fname = op.join(figures_dir, 'figSupp3_bayes_composition.png')
