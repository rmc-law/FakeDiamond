...
Plot Supplementary Figure - denotation effects in all tested ROIs
"""
...
for roi, subplot_label in zip(rois, subplot_labels):
    ...
    for relevant_condition, color, condition_name in zip(relevant_conditions,colors_tc,['subsective','privative']):
...
# 9. FINALIZE & SAVE
out_fname = op.join(figures_dir, 'figSupp2_denotation_allROIs.png')
