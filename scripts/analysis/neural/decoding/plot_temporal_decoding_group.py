...
for subject in subjects:
    ...
    decoding_score_array = op.join(decoding_dir, f'output/{analysis}/{subject}/scores_{analysis}_logistic_sensor_scores_temporal.npy')
...
plt.legend()
plt.savefig(op.join(figures_dir, f'fig_decoding_{analysis}_group.png'))
